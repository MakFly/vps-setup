...
```yaml
version: "1.0.0"
ansiblePath: "~/.local/share/vps-setup/ansible"
...
Chemin vers le répertoire contenant les playbooks Ansible. VPS Setup recherche le playbook principal dans `<ansiblePath>/playbooks/site.yml`.

```yaml
ansiblePath: "~/.local/share/vps-setup/ansible"
```

Utilisez un chemin absolu pour un provisioning prévisible depuis n'importe quel répertoire :
...
{
  "version": "1.0.0",
  "ansiblePath": "/home/user/.local/share/vps-setup/ansible",
  "defaultProfile": "full-stack",
  "logLevel": "info",
  "historyRetentionDays": 30
}
